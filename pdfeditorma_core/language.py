...
TAB_L = {
    ...
    "Russian": ["    合并文檔    ", "    分割頁面    ", "    檔案保護    ", "    元數據    "],
    "Turkmen": ["ファイル結合", "ページオルガナイズ", "電子透かし", "メタデータ"],
}
TIP_L = {
    "English": [
        "Open",
    ...
    "Russian": ["開啓檔案", "保存", "設定", "清除", "顔色", "預覽", "更多", "字體", "更新字體庫"],
    "Turkmen": ["開く", "保存する", "設定", "全て閉じる", "色選ぶ", "プレビュー", "詳細設定", "字体", "字体を更新"],
}
LAB_L3 = {
    "English": [
        "PASSWORD",
    ...
    "Russian": ["密碼", "水印", "字號：", "保存後開啓", "透明度：", "旋轉：", "預覽模式", "限制編輯"],
    "Turkmen": [
        "パスワード",
        "電子透かし",
        "フォントサイズ：",
...
LAB_L4 = {
    ...
    "Russian": ["題目", "作者", "主題", "關鍵詞"],
    "Turkmen": ["タイトル", "作者", "主題", "キーワード"],
}
LAB_LS = {
    "English": ["START DIR", "SAVE DIR", "OPEN AS PREVIOUS"],
    "Russian": ["開啓路徑", "保存路徑", "記住先前的路徑"],
